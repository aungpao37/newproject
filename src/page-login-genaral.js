...
export default class Pagelogingenaral extends Component {
    constructor(props) {
        super(props);
                ...
                <div className="portlet light portlet-fit">
                    <div className="portlet-title">
                        <div className="caption">
                            <span className="caption-subject font-red sbold uppercase">รายชื่อผู้ใช้งานทั่วไป</span>
                        </div>
                    </div>
                                            ...
                                            <table className="table table-hover table-bordered">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="ชื่อ" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}ชื่อ{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="นามสกุล" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}นามสกุล{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                                    <span className="caret" style={{ margin: '10px 0px 10px 5px', color: 'rgb(204, 204, 204)' }} /></span>
                                                                <span className="dropup"><span className="caret" style={{ margin: '10px 0px', color: 'rgb(204, 204, 204)' }} />
                                                                </span>
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="ชื่อผู้ใช้งาน" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}ชื่อผู้ใช้งาน{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                                    <span className="caret" style={{ margin: '10px 0px 10px 5px', color: 'rgb(204, 204, 204)' }} /></span>
                                                                <span className="dropup"><span className="caret" style={{ margin: '10px 0px', color: 'rgb(204, 204, 204)' }} />
                                                                </span>
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="ตำแหน่ง" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}ตำแหน่ง{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                                    <span className="caret" style={{ margin: '10px 0px 10px 5px', color: 'rgb(204, 204, 204)' }} /></span>
                                                                <span className="dropup"><span className="caret" style={{ margin: '10px 0px', color: 'rgb(204, 204, 204)' }} />
                                                                </span>
