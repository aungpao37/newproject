                ...
                <div className="portlet light portlet-fit">
                    <div className="portlet-title">
                        <div className="caption">
                            <span className="caption-subject font-red sbold uppercase">รายชื่อนักเรียน</span>
                        </div>
                    </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="ชื่อกลุ่ม" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}ชื่อกลุ่ม{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                        ...
                                                        <th className="sort-column" data-is-only-head="false" title="ชื่อห้อง" data-field="title" style={{ textAlign: 'left' }}>
                                                            {/* react-text: 248 */}รหัสกลุ่ม{/* /react-text */}<span className="order">
                                                                <span className="dropdown">
                                                                    <span className="caret" style={{ margin: '10px 0px 10px 5px', color: 'rgb(204, 204, 204)' }} /></span>
                                                                <span className="dropup"><span className="caret" style={{ margin: '10px 0px', color: 'rgb(204, 204, 204)' }} />
                                                                </span>
